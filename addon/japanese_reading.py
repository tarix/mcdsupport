...
#
# Modified From: https://github.com/dae/ankiplugins/blob/master/japanese/reading.py
...
supportDir = os.path.normpath(os.path.join(os.path.dirname(__file__), "../3918629684/support"))
